...
#include <stdint.h>
#include "main.h"
#include "../BMI088/delay.h"

#define key_down 0
#define key_up 1

//get stm32 chip temperature, to calc imu control temperature.获取stm32片内温度，计算imu的控制温�?
...
#define CALI_FUNC_CMD_INIT      0                   //has been calibrated, set value to init.已经校准过，设置校准�?
...
typedef __packed struct
{
    ...
    uint8_t flash_len : 7;                              //buf lenght				//冒号：数�? 是表示我定义了个 8个位�? flash_len 变量 但是我只用到 它的 7个位
